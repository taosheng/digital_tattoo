...
try:
    ...
    receiver_pub = Pubkey.from_string(os.getenv("RECEIVER_PUBLIC_KEY", "11111111111111111111111111111111"))
...
def check_balances():
    if not sender_key or not receiver_pub:
        print("Warning: Solana keys not configured.")
        return
    try:
